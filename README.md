...
This project will store into an Ethereum based Blockchain (Holesky Testnet), the data of temperature provided by Arduino.
...
* Now we have to choose a blockchain, on which storing the temperature and humidity data retrieved from the sensor based on the JSON generated by Arduino.
  For this example is used the TESTNET version of ETHEREUM HOLESKY BLOCKCHAIN ( https://holesky.etherscan.io );
  if you are not familiar with how a blockchain works, it is recommended to read more information here:
  [https://ethereum.org/guides](https://ethereum.org/guides).
  For this example EOA "0xa67a79cf9ead85879e2d15238707afc0a2f45eaa" is used on ETHEREUM HOLESKY TESTNET.
